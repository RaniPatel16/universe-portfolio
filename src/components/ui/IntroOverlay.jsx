...
export default function IntroOverlay() {
    ...
    useEffect(() => {
        ...
        const diagnostics = [
            ...
            'AI UPLINK: READY FOR COMMANDER ACTIONS...',
        ];
    ...
    const begin = () => {
        playVoice('Launch initiated. Safe journey, Commander.', '/assets/voice-launch.mp3');
        setPhase('journey');
    };
            ...
            {phase === 'intro' && (
              ...
              `}</style>
                            ...
                            <div className="w-full h-full rounded-xl bg-void/50 overflow-hidden flex items-center justify-center border border-white/5 relative z-10">
                                <svg viewBox="0 0 100 100" className="w-[85%] h-[85%] text-ion fill-none stroke-current" strokeWidth="1.2">
                                    {/* Concentric rings representing target focal */}
                                    <circle cx="50" cy="50" r="44" strokeDasharray="3 5" className="opacity-30" />
                                    <circle cx="50" cy="50" r="32" strokeDasharray="6 3" className="opacity-40 animate-pulse" />
                                    <circle cx="50" cy="50" r="20" className="opacity-20" />

                                    {/* Wireframe holographic face scanner geometry */}
                                    <path d="M50 16 C30 16, 26 36, 26 50 C26 70, 36 84, 50 84 C64 84, 74 70, 74 50 C74 36, 70 16, 50 16 Z" className="opacity-80" strokeWidth="1.6" />
                                    <path d="M32 46 Q50 35 68 46" className="opacity-60" />
                                    <path d="M30 54 Q50 48 70 54" className="opacity-60" />
                                    <path d="M35 62 Q50 56 65 62" className="opacity-50" />
                                    <path d="M42 70 Q50 68 58 70" className="opacity-40" />

                                    {/* Tech crosshair grid markings */}
                                    <line x1="50" y1="12" x2="50" y2="88" strokeDasharray="2 3" className="opacity-35" />
                                    <line x1="12" y1="50" x2="88" y2="50" strokeDasharray="2 3" className="opacity-35" />
                                    <circle cx="50" cy="50" r="1.5" fill="#35F0D0" />

                                    {/* Eyes / Tech sensors */}
                                    <circle cx="41" cy="48" r="2" fill="#35F0D0" className="animate-ping" />
                                    <circle cx="41" cy="48" r="1.5" fill="#35F0D0" />
                                    <circle cx="59" cy="48" r="2" fill="#35F0D0" className="animate-ping" />
                                    <circle cx="59" cy="48" r="1.5" fill="#35F0D0" />
                                </svg>

                                {/* Subtitle tag overlay */}
                                <div className="absolute bottom-1 inset-x-0 font-mono text-[7px] text-solar tracking-widest uppercase">
                                    HOST SYSTEM: ONLINE
                                </div>
                            </div>
                        </div>
